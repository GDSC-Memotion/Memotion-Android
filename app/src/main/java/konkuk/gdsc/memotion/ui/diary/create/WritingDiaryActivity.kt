...
class WritingDiaryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            btnWritingDiaryPost.text = if (version == 1) this@WritingDiaryActivity.getString(R.string.edit) else this@WritingDiaryActivity.getString(R.string.post)
        }
